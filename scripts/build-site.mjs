...
<body><a class="skip" href="#toolkit">Skip to the skills</a><div class="ambient" aria-hidden="true"></div><div class="shell"><header><a class="brand" href="https://www.tayloroneal.com/yoga"><span class="brand-mark" aria-hidden="true">✳</span><span>TAYLOR O’NEAL<small>YOGA / OPEN TOOLS</small></span></a><nav aria-label="Main navigation"><a href="#toolkit">The skills</a><a href="#start">How to use</a><a href="${repo}">GitHub ↗</a></nav></header>
